...
int add_to_stock() {
	...
	printf("Title of the book : "); input(title, 50);
	printf("Author : ");			input(author, 50);
	printf("Publisher : ");			input(publisher, 50);
	printf("Stock : ");				scanf("%d", &count);
	flush();
...
int approve_returns(){
	...
	i = valid_selection(db.manager.return_count+1);
	if(!i) return 0;
